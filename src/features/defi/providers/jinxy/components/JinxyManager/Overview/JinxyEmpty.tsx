...
type JinxyEmptyProps = {
  assets: Asset[]
  apy: string | undefined
  onClick?: () => void
}

export const JinxyEmpty = ({ assets, apy, onClick }: JinxyEmptyProps) => {
  return (
    <DefiModalContent>
      <EmptyOverview
        assets={assets}
        footer={
          <Button width='full' colorScheme='blue' onClick={onClick}>
            <Text translation='defi.modals.jinxyOverview.cta' />
          </Button>
        }
      >
        <Stack direction='row' flexWrap='wrap' spacing={1} justifyContent='center' mb={4}>
          <Text translation='defi.modals.jinxyOverview.header' />
        ...
        <Text color='text.subtle' translation='defi.modals.jinxyOverview.body' />
        <Text color='text.subtle' translation='defi.modals.jinxyOverview.rewards' />
      </EmptyOverview>
    </DefiModalContent>
  )
}
