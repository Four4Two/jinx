...
import type { UserUndelegation } from 'state/slices/opportunitiesSlice/resolvers/jinxy/types'
...
export const WithdrawCard = ({ asset, undelegation, canClaimWithdraw }: WithdrawCardProps) => {
  ...
  return (
    <Stack px={8} py={6}>
      <Text fontWeight='medium' translation='defi.modals.jinxyOverview.withdrawals' />
      {!hasClaim ? (
        <Text color='text.subtle' translation='defi.modals.jinxyOverview.emptyWithdraws' />
      ) : (
        <Button
          variant='input'
          width='full'
          ...
          >
            ...
            {isUndelegationAvailable ? (
              ...
              <Text
                ...
                lineHeight='shorter'
                translation={[
                  'defi.modals.jinxyOverview.availableDate',
