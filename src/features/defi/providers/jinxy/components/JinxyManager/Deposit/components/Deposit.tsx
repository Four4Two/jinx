...
export const Deposit: React.FC<DepositProps> = ({
  ...
  const opportunity = useMemo(() => state?.jinxyOpportunity, [state])
  ...
  const handleContinue = useCallback(
    async (formValues: DepositValues) => {
      if (!(state && accountAddress && dispatch && jinxyApi)) return
      ...
      dispatch({ type: JinxyDepositActionType.SET_DEPOSIT, payload: formValues })
