...
type JinxFarmingDepositProps = {
  onAccountIdChange: AccountDropdownProps['onChange']
  accountId: AccountId | undefined
}
export const JinxFarmingDeposit: React.FC<JinxFarmingDepositProps> = ({
  accountId,
  ...
  useEffect(() => {
    ;(() => {
      try {
        if (!(farmingAccountId && contractAddress && jinxFarmingOpportunity)) return
      } catch (error) {
        // TODO: handle client side errors
        console.error(error)
      }
    })()
  }, [farmingAccountId, translate, toast, contractAddress, jinxFarmingOpportunity])
  ...
  if (loading || !marketData || !jinxFarmingOpportunity || !StepConfig) {
    return (
