...
export const useJinxFarming = (
  ...
  const getStakeFees = useCallback(
    ...
    [adapter, accountNumber, contractAddress, jinxFarmingContract, lpAsset.precision, skip, wallet],
  )
  ...
  const getClaimFees = useCallback(
    ...
    [adapter, contractAddress, jinxFarmingContract, wallet],
  )
  ...
  const claimRewards = useCallback(async () => {
    ...
    return txid
  }, [accountNumber, adapter, ethAsset.chainId, contractAddress, jinxFarmingContract, skip, wallet])
