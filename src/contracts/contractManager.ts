...
import {
  ETH_JINX_POOL_CONTRACT_ADDRESS,
  ...
  ETH_JINX_STAKING_CONTRACT_ADDRESS_V7,
  JINX_TOKEN_CONTRACT_ADDRESS,
...
export const CONTRACT_ADDRESS_TO_TYPECHAIN_CONTRACT = {
  [ETH_JINX_POOL_CONTRACT_ADDRESS]: IUniswapV2Pair__factory,
  [ETH_JINX_STAKING_CONTRACT_ADDRESS_V1]: FarmingAbi__factory,
  [ETH_JINX_STAKING_CONTRACT_ADDRESS_V2]: FarmingAbi__factory,
  [ETH_JINX_STAKING_CONTRACT_ADDRESS_V3]: FarmingAbi__factory,
  [ETH_JINX_STAKING_CONTRACT_ADDRESS_V4]: FarmingAbi__factory,
  [ETH_JINX_STAKING_CONTRACT_ADDRESS_V5]: FarmingAbi__factory,
  [ETH_JINX_STAKING_CONTRACT_ADDRESS_V6]: FarmingAbi__factory,
  [ETH_JINX_STAKING_CONTRACT_ADDRESS_V7]: FarmingAbi__factory,
  [JINX_TOKEN_CONTRACT_ADDRESS]: ERC20ABI__factory,
