...
const validators = {
  ...
  REACT_APP_UNCHAINED_HIGHBURY_HTTP_URL: url(),
  REACT_APP_UNCHAINED_HIGHBURY_WS_URL: url(),
  ...
  REACT_APP_HIGHBURY_NODE_URL: url(),
  ...
  REACT_APP_FEATURE_HIGHBURY: bool({ default: false }),
