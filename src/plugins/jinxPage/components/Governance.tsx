    ...
    <Card display='block' width='full'>
      <CardHeader>
        <Flex flexDirection='row' justifyContent='space-between' alignItems='center' mb={2}>
          <Text translation='plugins.jinxPage.governanceTitle' fontWeight='bold' color='inherit' />
          <Link isExternal href={SNAPSHOT_BASE_URL} fontWeight='semibold' color={linkColor}>
            <Text translation='plugins.jinxPage.seeAllProposals' />
          </Link>
        </Flex>
        <Text translation='plugins.jinxPage.governanceDescription' color='text.subtle' />
      </CardHeader>
      <Skeleton
