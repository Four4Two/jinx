  ...
  return (
    <Card display='block' width='auto'>
      <CardHeader>
        ...
        <Text translation='plugins.jinxPage.mainStakingDescription' color='text.subtle' />
      </CardHeader>
      <CardBody>
        <Flex
          width='full'
        ...
        >
          ...
          <Flex
            ...
            alignItems={{ base: 'center', md: 'flex-start' }}
          >
            <Text translation='plugins.jinxPage.tvl' color='text.subtle' mb={1} />
          ...
          <Flex
            ...
            alignItems={{ base: 'center', md: 'flex-start' }}
          >
            <Text translation='plugins.jinxPage.balance' color='text.subtle' mb={1} />
